...
open class JTAppleCalendarView: UICollectionView {
    ...
    func scrollTo(indexPath: IndexPath, isAnimationEnabled: Bool, position: UICollectionView.ScrollPosition, extraAddedOffset: CGFloat, completionHandler: (() -> Void)?) {
    ...
    func scrollToHeaderInSection(_ section: Int,
        ...
        DispatchQueue.main.async {
            if let attributes = self.layoutAttributesForSupplementaryElement(ofKind: UICollectionView.elementKindSectionHeader, at: indexPath) { // JT101 this was changed --> we need this function inside the layout
